...
const ProductListCard = ({
  ...
  return (
    <Link href={`/home/product/${id}`}>
      <div
        className="sm:w-[400px] relative z-[0] aspect-[11/12] bg-[rgba(248,248,248,0.1)] shadow-md hover:shadow-xl flex flex-col justify-between cursor-pointer transition ease-linear delay-75 my-10 border-2 border-transparent hover:border-[rgba(0,0,0,0.1)]  hover:scale-105"
        key={id}>
