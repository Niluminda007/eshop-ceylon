...
const SearchBar = () => {
  return (
    <div className="sm:flex relative hidden">
      ...
      />
      <button className="bg-black rounded-full h-8 w-8 text-lg flex justify-center items-center absolute top-[50%] -translate-y-[50%] right-2 transition-all hover:scale-[1.1] hover:shadow-md">
